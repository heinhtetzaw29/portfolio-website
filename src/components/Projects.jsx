...
function ComingSoonCard({ project }) {
  return (
    <div className="flex flex-col">
      <div className="mb-4 flex aspect-[4/3] items-center justify-center border border-dashed border-ink/40 bg-white">
        <span className="text-label uppercase text-muted">Coming Soon</span>
      </div>
      <h3 className="text-section text-muted">{project.title}</h3>
